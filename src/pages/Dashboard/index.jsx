      ...
      case 0:
        return (
          <div>
            ...
            officia similique modi architecto animi voluptatem dolores
            accusantium aliquam, fugiat placeat fugit vel dolore asperiores
            officiis quasi sit odit consequatur facilis?
          </div>
        );
      case 1:
        return (
          ...
          <div className="gridContainer">
            <div className="one gridChild">
              <div className={Styles.titleWrapper}>
                <h2 style={{ color: "#e74c3c" }}>$ 456 832</h2>
                <img src="/assets/down.svg" alt="" className="icon" />
              </div>
              <p className={`${Styles.subtitle} uppercase`}>
                Total Profit Earned
              </p>
                ...
                <div className={Styles.pieWrapper}>
                  <div>
                    <ul className={Styles.pieList}>
                      ...
                      <li>
                        <div style={{ backgroundColor: "rgb(59, 223, 122)" }} />
                        Online Check-in
                      </li>
                      <li>
                        <div
